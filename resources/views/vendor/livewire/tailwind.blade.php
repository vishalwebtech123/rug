<div>
    @if ($paginator->hasPages())
        @php(isset($numberOfPaginatorsRendered[$paginator->getPageName()]) ? $numberOfPaginatorsRendered[$paginator->getPageName()]++ : $numberOfPaginatorsRendered[$paginator->getPageName()] = 1)
                        ...
                        @foreach ($elements as $element)
                            ...
                            @if (is_array($element))
                                @foreach ($element as $page => $url)
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-{{ $numberOfPaginatorsRendered[$paginator->getPageName()] }}-page{{ $page }}">
