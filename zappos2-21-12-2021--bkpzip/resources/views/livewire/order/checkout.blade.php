<x-admin-layout>
    <section class="full-width flex-wrap admin-full-width list-customers">
        <div class="page_header d-flex align-item-center justify-content-space-between full-width mb-2">
            <h4 class="mb-0 fw-5">Abandoned Checkouts</h4>
            <div class="header-btn-group">
                <a class="button green-btn" data-toggle="modal" data-target="#export" >Export</a>
            </div>
        </div>
    </section>
                    ...
                    <div class="columns" wire:ignore="">
                        <div class="input-group">
                            ...
                            <div class="search-product-field">
                                <input class="fs-13 placeholder_gray fw-4" type="search" name="search_products" id="search_products" placeholder="Filter items">
                            </div>
                            <div class="form-field">
                                ...
                                <div class="fs-14 fw-6 status-dropdown dropdown-field">
                                    ...
                                    <ul class="filter_main_email_subscription_status filter-dropdown model">
                                        ...
                                        <li><input value="Canceled" id="canceled" type="radio" class="change-filter"> <label for="subscribed">Any</label></li>
                                ...
                                <div class="payment-dropdown dropdown-field">
                                    ...
                                    <ul class="filter_main_tagged_with filter-dropdown model">
                                        <li><input value="Open" id="open" type="radio" class="change-filter"> <label for="subscribed">Not Recovered</label></li>
                                        <li><input value="Archived" id="archived" type="radio" class="change-filter"> <label for="subscribed">Recovered</label></li>
                                        <li><input value="Canceled" id="canceled" type="radio" class="change-filter"> <label for="subscribed">Any</label></li>
                                        <li><a class="clear-btn" type="button">Clear</a>
                                        </li>
                                    </ul>
                            ...
                            <div class="sort-btn">
                                ...
                                <ul class="filter_main_email_subscription_status filter-dropdown model">
                                    ...
                                    <li>
                                        ...
                                        <label for="subscribed">Checkout number (ascending)</label>
                                    </li>
                                    <li>
                                        <input value="Subscription Pending Confirmation" id="subscribed-pending" type="radio" class="change-filter">
                                        <label for="subscribed-pending">Checkout number (descending)</label>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <input value="Subscribed" id="subscribed" type="radio" class="change-filter">
                                        <label for="subscribed">Email status (A-Z)</label>
                                    </li>
                                    <li>
                                        <input value="Subscription Pending Confirmation" id="subscribed-pending" type="radio" class="change-filter">
                                        <label for="subscribed-pending">Email status (Z-A)</label>
                                    </li>
                                    <li>
                                        <input value="Not subscribed" id="not-subscribed" type="radio" class="change-filter">
                                        <label for="not-subscribed">Recovery status (A-Z)</label>
                                    </li>
                                    <li>
                                        <input value="Subscribed" id="subscribed" type="radio" class="change-filter">
                                        <label for="subscribed">Recovery status (Z-A)</label>
                                    </li>
                                    <li>
                                        <input value="Subscription Pending Confirmation" id="subscribed-pending" type="radio" class="change-filter">
                ...
                <table class="one-bg border-every-row fs-14 fw-3 table-padding-side0 tc-black01 comman-th order-listing">
                    <tbody>
                        <tr>
                            ...
                            <th class="sticky-col">Checkout</th>
                            <th class="fw-6">
                        ...
                        <tr>
                            ...
                            <td class="fw-6 sticky-col"><a href="{{ route('checkout-detail') }}">#20931118956659</a></td>
                            <td></td>
                            <td>
                               12 Jul at 21:16
                            </td>
                            <td>
                                <button class="link">Latongie Holland <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true"><path d="M10 2a8 8 0 1 1 0 16 8 8 0 0 1 0-16zM8.293 6.293a1 1 0 0 0 0 1.414L10.586 10l-2.293 2.293a1 1 0 1 0 1.414 1.414l3-3a1 1 0 0 0 0-1.414l-3-3a1 1 0 0 0-1.414 0z"></path></svg></button>
                            </td>
                            <td>
                                <span class="tag orange">Not Sent</span>
                            </td>
                            <td>
                                <span class="tag orange">Not Recovered</span>
                            </td>
                            <td>
                                $100,00
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="fw-6 sticky-col">#20931118956659</td>
                            <td></td>
                            <td>
                               12 Jul at 21:16
                            </td>
