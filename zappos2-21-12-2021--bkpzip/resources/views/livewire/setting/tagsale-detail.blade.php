        ...
        <article class="full-width">
            ...
            <div class="columns customers-details-heading">
                ...
                <div class="page_header d-flex  align-item-center mb-3">
                    ...
                    <h4 class="mb-0 fw-5">Edit Tag Sale</h4>
...
<form enctype="multipart/form-data" id="add_people_form" autocomplete="off">
    <section class="full-width flex-wrap admin-body-width customers-details-sec product-details-sec" wire:ignore>
         ...
         <article class="full-width">
            ...
            <div class="columns two-thirds">
                ...
                <div class="card">
                    ...
                    <input type="text" wire:model="tagsale.title" name="title" placeholder="Short sleeve t-shirt">
                ...
                <div class="card product-media-card">
                    ...
                    <div class="card-middle">
                        <div class="uplod-main-demo">
                            <input type="file" wire:model="image" id="images"/>
    ...
    <section class="full-width flex-wrap admin-body-width create-collection-footer">
        ...
        <div class="page-bottom-btn">
            ...
            <input type="submit" class="button"id="master-save" wire:click="updateDetail" value="save">
